public class Runner {
    public static void main(String[] args) {
        ...
        Balloon balloon3 = new Balloon("Green","Plastic");
        Balloon balloon4 = new Balloon("white","Latex",16);
        Balloon balloon5 = new Balloon("Pink","Plastic",15,"heart");
        Balloon balloon6 = new Balloon("Purple", "Latex",9,"Round",10);
        Balloon balloon7 = new Balloon("Red","Plastic",9,"Round",10,3);
        ...
        Holi holi3 = new Holi("Green",400);
        Holi holi4 = new Holi("Pink",300,"Hoil");
        Holi holi5 = new Holi("Pink",100,"Hoil",2025);
        Holi holi6 = new Holi("Purple",250,"Hoil",2024,false);
        Holi holi7 = new Holi("Red",50,"Hoil",2055,false,50.25);
